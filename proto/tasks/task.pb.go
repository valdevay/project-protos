...
func (x *ListTasksByUserRequest) GetOffset() uint32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
const file_tasks_task_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\rR\x02id2\xf4\x02\n" +
	"\vTaskService\x12?\n" +
	"\n" +
	...
	"\x0fListTasksByUser\x12\x1c.task.ListTasksByUserRequest\x1a\x1d.task.ListTasksByUserResponse\x122\n" +
	"\n" +
	"UpdateTask\x12\n" +
	".task.Task\x1a\x18.task.UpdateTaskResponse\x12?\n" +
	"\n" +
...
var file_tasks_task_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_tasks_task_proto_goTypes = []any{
	...
	(*ListTasksByUserResponse)(nil), // 6: task.ListTasksByUserResponse
...
var file_tasks_task_proto_depIdxs = []int32{
	...
	9,  // 15: task.TaskService.DeleteTask:output_type -> task.DeleteTaskResponse
